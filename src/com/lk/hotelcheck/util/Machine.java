...
public class Machine {
	...
	private final static String MEIZUBOARD[] = { "m9", "mx", "mx2", "mx3", "mx4" };
...
//		return false;
	...
	public static String getPhoneNumber(Context context) {
		...
		try {
			...
			if (phone != null) {
				phone = UtilTool.isLegalPhoneNumber(phone) ? phone : null;
			}
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
...
//		String imei = telephonyManager.getDeviceId();
//		if (imei == null) {
//			imei = StatisticsManager.getGOID(context);
//		}
//		return imei;
//	}
...
//		PreferencesManager sharedPreferences = PreferencesManager.getSharedPreference(context, SHAREDPREFERENCES_RANDOM_DEVICE_ID, Context.MODE_PRIVATE);
